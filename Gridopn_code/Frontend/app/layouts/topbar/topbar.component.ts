...
export class TopbarComponent implements OnInit {
  ...
  ngOnInit(): void {
      // ---------- IMPORTANT FIX ----------
    // Reactively update topbar username on login
    this.authService.currentUser.subscribe(user => {
      this.userData = user || this.TokenStorageService.getUser() || {};
      // console.log("TOPBAR UPDATED USER:", this.userData);
    });

    // Load initial user (page refresh)
